...
public class ItemDrops extends EntityObject{
	...
	public void tick() {
		...
		if (game.WPressed && !game.SPressed) {
			if (game.collision.checkY(game.x, game.y, game.TileX, game.TileY, game.ChunkX, game.ChunkY, (int) game.VelX, (int) game.VelY)) {
				y += (game.TileHeight/8);
		...
		if (game.APressed && !game.DPressed) {
			if (game.collision.checkX(game.x, game.y, game.TileX, game.TileY, game.ChunkX, game.ChunkY, (int) game.VelX, (int) game.VelY)) {
				x += (game.TileWidth/8);
			}
		}
