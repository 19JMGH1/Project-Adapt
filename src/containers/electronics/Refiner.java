...
public class Refiner extends Electronic{
	...
	public Refiner(Main_Game game, short id, int chunkX, int chunkY, int tileX, int tileY) {
		super(game, id, ContainerIDs.Refiner, validSlots, "Files/File "+game.CurrentFile+"/Tiles/Refiner "+id+".txt", neededValues, chunkX, chunkY, tileX, tileY, baseMaxPower, powerTransfer);
