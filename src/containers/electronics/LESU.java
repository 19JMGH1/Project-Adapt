...
public class LESU extends Electronic{
	...
	public LESU(Main_Game game, short id, int chunkX, int chunkY, int tileX, int tileY) {
		super(game, id, ContainerIDs.LESU, validSlots, "Files/File "+game.CurrentFile+"/Tiles/LESU "+id+".txt", neededValues, chunkX, chunkY, tileX, tileY, baseMaxPower, powerTransfer);
