...
public abstract class Electronic extends ContainerProcessors{ //The energy units that appear in the game will be Joules and Watts (Jules for power stored, watts for power transfer)
	...
	Electronic(Main_Game game, short id, ContainerIDs containerID, boolean[][] validSlots, String fileName, byte neededValues, int chunkX, int chunkY, int tileX, int tileY, int maxPower, short powerTransfer) {
