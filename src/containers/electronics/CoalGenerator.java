...
public class CoalGenerator extends Electronic{
	...
	public CoalGenerator(Main_Game game, short id, int chunkX, int chunkY, int tileX, int tileY) {
		super(game, id, ContainerIDs.CoalGenerator, validSlots, "Files/File "+game.CurrentFile+"/Tiles/CoalGenerator "+id+".txt", neededValues, chunkX, chunkY, tileX, tileY, baseMaxPower, powerTransfer);
