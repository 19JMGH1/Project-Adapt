...
public class Collision {
	...
	public boolean checkX(int X, int Y, int tileX, int tileY, int chunkX, int chunkY, int velX, int velY)
	{
		if (velX == 0)
		{
			return true;
	...
	public boolean checkY(int X, int Y, int tileX, int tileY, int chunkX, int chunkY, int velX, int velY)
	{
		if (velY == 0)
		{
			return true;
